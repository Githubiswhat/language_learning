...
| 30  | Go语言精进之路vol2 | p79 | p79页源码有typo，具体见[issue32](https://github.com/bigwhite/GoProgrammingFromBeginnerToMaster/issues/32) | [bestgopher](https://github.com/bestgopher)  | typo | blockprofile代码中的pprof.Lookup("mutex")改为pprof.Lookup("block") | 未改 |
